...
6. Start the microservice using FastAPI's CLI:
...
7. Follow the [post setup instructions](#post-setup-instructions)
...
For development replica sets are required to be able to use transactions. To setup for use with a single replica set you
should first generate a keyfile to use e.g.
