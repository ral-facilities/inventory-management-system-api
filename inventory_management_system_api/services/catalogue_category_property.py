    ...
    def create(
        ...
        with start_session_transaction("adding property") as session:
            ...
            catalogue_category_property_out = self._catalogue_category_repository.create_property(
                ...
                catalogue_category_property_in,
                username,
            ...
            self._item_repository.insert_property_to_all_in(
                catalogue_item_ids, property_in, username, catalogue_category_property.modified_comment, session=session
            )
    ...
    def delete(self, catalogue_category_id: str, catalogue_category_property_id: str, username: str) -> None:
        ...
        with start_session_transaction("deleting property") as session:
            self._catalogue_category_repository.delete_property(
                catalogue_category_id=catalogue_category_id, property_id=catalogue_category_property_id, session=session
            )
