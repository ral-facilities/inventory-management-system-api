...
class UsageStatusRepo:
    ...
    def delete(self, usage_status_id: str) -> None:
        ...
        """
        usage_status_id = CustomObjectId(usage_status_id)
        if self._is_usage_in_item(str(usage_status_id)):
        ...
        result = self._usage_statuses_collection.delete_one({"_id": usage_status_id})
    ...
    def _is_usage_in_item(self, usage_status_id: str) -> bool:
        ...
        """
        usage_status_id = CustomObjectId(usage_status_id)
        return self._items_collection.find_one({"usage_status_id": usage_status_id}) is not None
