...
CATALOGUE_CATEGORY_PROPERTY_OUT_DATA_BOOLEAN_MANDATORY = {
...
CATALOGUE_CATEGORY_PROPERTY_OUT_DATA_NUMBER_NON_MANDATORY_WITH_MM_UNIT = {
    **CATALOGUE_CATEGORY_PROPERTY_IN_DATA_NUMBER_NON_MANDATORY_WITH_MM_UNIT,
    "id": ObjectId(),
    "unit_id": ObjectId(CATALOGUE_CATEGORY_PROPERTY_IN_DATA_NUMBER_NON_MANDATORY_WITH_MM_UNIT["unit_id"]),
}
...
CATALOGUE_CATEGORY_PROPERTY_OUT_DATA_STRING_NON_MANDATORY_WITH_ALLOWED_VALUES_LIST = {
    **CATALOGUE_CATEGORY_PROPERTY_DATA_STRING_NON_MANDATORY_WITH_ALLOWED_VALUES_LIST,
    "id": ObjectId(),
    "unit_id": str(CATALOGUE_CATEGORY_PROPERTY_IN_DATA_STRING_NON_MANDATORY_WITH_ALLOWED_VALUES_LIST["unit_id"]),
}
...
CATALOGUE_CATEGORY_OUT_DATA_LEAF_NO_PARENT_WITH_PROPERTIES_MM = {
    **CATALOGUE_CATEGORY_IN_DATA_LEAF_NO_PARENT_WITH_PROPERTIES_MM,
    **CREATED_MODIFIED_OUT_DATA,
    "_id": ObjectId(),
    "properties": [
...
BASE_CATALOGUE_CATEGORY_OUT_DATA_WITH_PROPERTIES_MM = CATALOGUE_CATEGORY_OUT_DATA_LEAF_NO_PARENT_WITH_PROPERTIES_MM
...
CATALOGUE_ITEM_OUT_DATA_NOT_OBSOLETE_NO_PROPERTIES = {
    ...
    **CREATED_MODIFIED_OUT_DATA,
    "_id": ObjectId(),
    "catalogue_category_id": ObjectId(CATALOGUE_ITEM_IN_DATA_NOT_OBSOLETE_NO_PROPERTIES["catalogue_category_id"]),
    "manufacturer_id": ObjectId(CATALOGUE_ITEM_IN_DATA_NOT_OBSOLETE_NO_PROPERTIES["manufacturer_id"]),
}
...
MANUFACTURER_OUT_DATA_A = {**MANUFACTURER_IN_DATA_A, **CREATED_MODIFIED_OUT_DATA, "_id": ObjectId()}
