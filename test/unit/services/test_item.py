...
class CreateDSL(ItemServiceDSL):
    ...
    def call_create(self) -> None:
        ...
        self._created_item = self.item_service.create(self._item_post, self._user_authorised, username="Test user")
    ...
    def call_create_expecting_error(self, error_type: type[BaseException]) -> None:
        ...
        with pytest.raises(error_type) as exc:
            self.item_service.create(self._item_post, self._user_authorised, username="Test user")
...
class UpdateDSL(ItemServiceDSL):
    ...
    def call_update(self, item_id: str) -> None:
        ...
        self._updated_item = self.item_service.update(item_id, self._item_patch, self._user_authorised, username="Test user")
    ...
    def call_update_expecting_error(self, item_id: str, error_type: type[BaseException]) -> None:
        ...
        with pytest.raises(error_type) as exc:
            self.item_service.update(item_id, self._item_patch, self._user_authorised, username="Test user")
