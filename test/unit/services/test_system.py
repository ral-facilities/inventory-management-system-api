...
class CreateDSL(SystemServiceDSL):
    ...
    def call_create(self) -> None:
        ...
        self._created_system = self.system_service.create(self._system_post, username="Test user")
    ...
    def call_create_expecting_error(self, error_type: type[BaseException]) -> None:
        ...
        with pytest.raises(error_type) as exc:
            self.system_service.create(self._system_post, username="Test user")
...
class UpdateDSL(SystemServiceDSL):
    ...
    def call_update(self, system_id: str) -> None:
        ...
        self._updated_system = self.system_service.update(system_id, self._system_patch, username="Test user")
    ...
    def call_update_expecting_error(self, system_id: str, error_type: type[BaseException]) -> None:
        ...
        with pytest.raises(error_type) as exc:
            self.system_service.update(system_id, self._system_patch, username="Test user")
...
class TestUpdate(UpdateDSL):
    ...
    def test_update_all_fields_except_type_id(self):
        """Test updating all fields of a system except its type ID."""
    ...
    def test_update_type_id(self):
        """Test updating the type ID of a system ."""
    ...
    def test_update_type_id_with_spares_definition_defined(self):
        """Test updating the type ID of a system when there is a spares definition defined."""
