...
@patch("inventory_management_system_api.core.database.mongodb_client")
def test_start_session_transaction_with_write_conflict(mock_mongodb_client):
    """Test `start_session_transaction` when there is a write conflict inside the transaction."""
